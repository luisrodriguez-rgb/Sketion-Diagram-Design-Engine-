...
class BrandRegistry:
    ...
    _BRANDS: Dict[str, BrandSpec] = {
        ...
        "kubernetes": BrandSpec("kubernetes", "Kubernetes (K8s)", "ORCHESTRATION", "#326CE5", "#EFF6FF", "server", ["Kubernetes", "K8s", "Pods", "Ingress"]),
        "docker": BrandSpec("docker", "Docker Containers", "CONTAINER", "#2496ED", "#EFF6FF", "server", ["Docker", "Containers", "Dockerfile"]),
        "terraform": BrandSpec("terraform", "HashiCorp Terraform", "IAC", "#7B42BC", "#F5EEFF", "server", ["Terraform", "HCL"]),

        # 2. BASES DE DATOS & STORAGE
        "postgresql": BrandSpec("postgresql", "PostgreSQL", "DATABASE_ACID", "#336791", "#EFF6FF", "database", ["PostgreSQL", "Postgres", "PgSQL", "ACID"]),
        "aurora": BrandSpec("aurora", "AWS Aurora PostgreSQL", "DATABASE_ACID", "#336791", "#EFF6FF", "database", ["Aurora", "Multi-AZ"]),
        "redis": BrandSpec("redis", "Redis In-Memory", "CACHE_KEYVALUE", "#DC382D", "#FFF5F2", "server", ["Redis", "Redlock"]),
        "mongodb": BrandSpec("mongodb", "MongoDB Document DB", "NOSQL", "#47A248", "#F0FDF4", "database", ["MongoDB", "BSON", "Atlas"]),
        "clickhouse": BrandSpec("clickhouse", "ClickHouse OLAP", "DATABASE_OLAP", "#FFCC00", "#FFFBEB", "database", ["ClickHouse", "Columnar"]),
        "dynamodb": BrandSpec("dynamodb", "Amazon DynamoDB", "NOSQL", "#4053D6", "#EEF2FF", "database", ["DynamoDB", "Single-Digit MS"]),
        "minio": BrandSpec("minio", "MinIO Object Storage", "STORAGE_S3", "#C72C48", "#FFF5F5", "database", ["MinIO", "S3 Compatible"]),
        "snowflake": BrandSpec("snowflake", "Snowflake Data Cloud", "DATA_WAREHOUSE", "#29B5E8", "#F0F9FF", "database", ["Snowflake", "Snowpipe"]),
        "supabase": BrandSpec("supabase", "Supabase Backend", "BAAS", "#3ECF8E", "#ECFDF5", "database", ["Supabase", "Realtime Auth"]),
        "firebase": BrandSpec("firebase", "Google Firebase", "BAAS", "#FFCA28", "#FFFBEB", "server", ["Firebase", "Firestore"]),

        # 3. STREAMING & QUEUES
        "kafka": BrandSpec("kafka", "Apache Kafka", "STREAMING", "#231F20", "#F8FAFC", "terminal", ["Kafka", "MirrorMaker"]),
        "rabbitmq": BrandSpec("rabbitmq", "RabbitMQ Message Broker", "QUEUE", "#FF6600", "#FFF7ED", "terminal", ["RabbitMQ", "AMQP"]),
        "flink": BrandSpec("flink", "Apache Flink", "STREAM_PROCESSING", "#E65243", "#FFF5F2", "server", ["Flink"]),
        "spark": BrandSpec("spark", "Apache Spark", "DATA_PROCESSING", "#E25A1C", "#FFF7ED", "server", ["PySpark"]),
